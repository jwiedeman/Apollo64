...
- `LM_SURFACE_060`–`LM_SURFACE_064`: Apollo 11 Flight Plan Section 7 contingency surface operations notes (pp. 7-31 to 7-35), Mission Operations Report Appendix 3 surface science discussions, and MSC Surface Traverse Planning Annex excerpts covering the optional EVA-2 extension.
...
- `RETURN_COMM_015`, `RETURN_COMM_023`, `RETURN_COMM_028`: Apollo 11 Flight Plan Section 8 (pp. 8-13, 8-17, 8-19) DSN schedule tables and Flight Journal Day 6–7 transearth communications transcripts for high-gain configuration, PAD updates, and entry handover context.
...
- `FP_7-31_EVA2_PREP` – `FP_7-35_EVA2_CLOSEOUT`: Apollo 11 Flight Plan Section 7 contingency EVA extension tables (pp. 7-31 to 7-35), Surface Traverse Planning Annex station maps, and Flight Journal Day 6 planning transcripts documenting the optional EVA-2 objectives.
...
- `FP_8-13_TRANSCOMM_A`, `FP_8-17_TRANSCOMM_B`, `FP_8-19_TRANSCOMM_C`: Apollo 11 Flight Plan Section 8 DSN support schedule (pp. 8-13, 8-19) and Flight Journal Day 6–7 communications loops for transearth pass procedures.
...
- Surface EVA and transearth communications failure hooks reference Apollo 11 Flight Plan Section 7 EVA procedures (pp. 7-26 to 7-35), Section 8 DSN schedules (pp. 8-13, 8-17), Surface Traverse Planning Annex contingency guidance, and Flight Journal Day 5–6 transcripts for timeline constraints.
