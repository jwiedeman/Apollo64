...
- **Docking simulation blueprint:** Follow [`docs/sim/docking_simulation.md`](../sim/docking_simulation.md) for the rendezvous state model, gate evaluation rules, manual/autopilot parity hooks, scoring integration, and validation criteria that will steer the implementation.
