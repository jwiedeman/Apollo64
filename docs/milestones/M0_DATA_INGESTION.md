...
- Surface EVA-1 prep/egress/traverse/closeout plus the optional EVA-2 contingency extension and transearth DSN communications passes now contribute resource deltas, checklists, failure hooks, and signal-strength analytics aligned to Flight Plan Sections 7–8, Surface Traverse Planning Annex notes, and Flight Journal Day 5–6 coverage.
