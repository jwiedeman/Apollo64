...
- Text HUD snapshots generated by [`js/src/hud/textHud.js`](js/src/hud/textHud.js) now surface mission progress, resource margins, propellant usage, checklist activity, and manual action queue status at configurable intervals during CLI runs, aiding long-session monitoring.
